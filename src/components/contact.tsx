...
export const  Contact =()=> {
    return (
        <Section
            ...
            title={
                <>
                    Let&#39;s build something <em className="text-gradient-gold not-italic">exceptional</em>.
                </>
            }
        ...
        >
            <div className="grid gap-6 lg:grid-cols-[1fr_1.1fr]">
                <div className="space-y-3">
                    {[
                        { icon: Github, href: "https://github.com/Raymondkingjnr", label: "GitHub" },
                        { icon: Linkedin, href: "https://linkedin.com/in/raymond001", label: "LinkedIn" },
                    ...
                    <form
                        className="glass space-y-4 rounded-md p-3 sm:p-5"
                    >
                    <div className="grid gap-4 sm:grid-cols-2">
                        <label className="block">
                            <span className="mb-1.5 block text-xs uppercase tracking-wider text-muted-foreground">Name</span>
                            <input className="w-full rounded-xl border border-white/5 bg-white/2 px-4 py-3 text-sm outline-none transition-colors focus:border-gold" placeholder="Ada Umeh" />
                        </label>
                        <label className="block">
                            <span className="mb-1.5 block text-xs uppercase tracking-wider text-muted-foreground">Email</span>
                            <input type="email" className="w-full rounded-xl border border-white/5 bg-white/2 px-4 py-3 text-sm outline-none transition-colors focus:border-gold" placeholder="you@company.com" />
                        </label>
                    </div>
                    <label className="block">
                        <span className="mb-1.5 block text-xs uppercase tracking-wider text-muted-foreground">Company (optional)</span>
                        <input className="w-full rounded-xl border border-white/5 bg-white/2 px-4 py-3 text-sm outline-none transition-colors focus:border-gold" placeholder="Acme Inc." />
                    </label>
                    <label className="block">
                        <span className="mb-1.5 block text-xs uppercase tracking-wider text-muted-foreground">Project details</span>
                        <textarea rows={5} className="w-full resize-none rounded-xl border border-white/5 bg-white/2 px-4 py-3 text-sm outline-none transition-colors focus:border-gold" placeholder="Tell me about what you're building…" />
                    </label>
                    <button
                        type="submit"

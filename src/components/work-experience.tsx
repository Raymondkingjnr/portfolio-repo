      ...
      <div className="max-w-[1600px] mx-auto py-[5rem] px-[1.5rem]">
        ...
        <div className="mt-[2rem] flex gap-y-[3rem] gap-x-[8rem] flex-col md:flex-row justify-between">
          <PopInSection>
            ...
            <ul className="flex darkThemeText flex-col gap-[1rem] mt-[1.8rem]">
          ...
          <PopInSection>
            <aside className="flex justify-between items-center">
              <h1 className="uppercase text-base darkThemeText md:text-lg font-semibold pb-4">
                OneWay
              </h1>
            </aside>
            <p className="pb-1 text-sm font-bold darkThemeText">
            ...
            <ul className="flex flex-col gap-[1rem] mt-[1.8rem] darkThemeText">
              <li className="text-sm leading-[1.6rem] font-medium">
